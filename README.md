...
**From a release:** download the latest `steam-achievements.zip` from the [Releases](../../releases) page.

1. Transfer it to your Steam Deck.
2. Open the Decky Loader settings → **Developer** tab.
3. Select **Install Plugin from ZIP file** and pick the plugin ZIP.
...
npm run build
```
This produces `dist/index.js`. Zip up the plugin folder the same way as above and install it as described.
