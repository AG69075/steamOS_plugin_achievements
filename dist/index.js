...
function CompletionRibbonIcon(props) {
    const size = props.size || 16;
    return SP_REACT.createElement("svg", {
        "aria-hidden": "true", viewBox: "0 0 24 24", focusable: "false",
        style: { width: size, height: size, display: 'block', flexShrink: 0, ...(props.style || {}) }
    },
        SP_REACT.createElement("path", { d: "M7 13 L4 22 L9.5 19.5 L12 23 L14.5 19.5 L20 22 L17 13 Z", fill: "#2a6fb5" }),
        SP_REACT.createElement("circle", { cx: "12", cy: "9", r: "7", fill: "#67c1f5" }),
        SP_REACT.createElement("circle", { cx: "12", cy: "9", r: "7", fill: "none", stroke: "#c7e7fb", "stroke-width": "1" }),
        SP_REACT.createElement("path", { d: "M9 9 L11 11 L15.5 6.2", fill: "none", stroke: "#0a2f4d", "stroke-width": "1.8", "stroke-linecap": "round", "stroke-linejoin": "round" })
    );
}
...
const SettingsPanel = () => {
    ...
    return (SP_REACT.createElement(DFL.PanelSection, { title: "Steam Achievements" },
        ...
        SP_REACT.createElement(DFL.PanelSectionRow, null,
            SP_REACT.createElement(DFL.Field, { label: "Trophy icon" },
                SP_REACT.createElement(DFL.ButtonItem, {
                    layout: "below",
                    onClick: () => setSetting({ showTrophyIcon: !settings.showTrophyIcon })
...
const findAchievementList = (obj, depth = 0) => {
...
// (per DoomTay's find). This is an undocumented internal API, so we guard
// against several failure modes:
...
const tryLocalAchievements = async (appid) => {
    try {
...
const AchievementsBadge = () => {
    ...
    const renderScores = () => {
        ...
        const pct = data.achievements_total > 0
            ? (data.achievements_unlocked / data.achievements_total) * 100
            : 0;
        ...
        return SP_REACT.createElement("div", { className: "achdeck-scores", style: { gap: showTrophyIcon ? '2px' : '8px' } },
            ...
            SP_REACT.createElement("div", { className: "achdeck-row achdeck-value-row" },
                SP_REACT.createElement("span", { className: "achdeck-icon-slot", style: { width: 20, minWidth: 20 } },
                    isComplete ? SP_REACT.createElement(CompletionRibbonIcon, { size: 20 }) : null),
                ...
                SP_REACT.createElement("div", { className: "achdeck-progress-track" },
                    SP_REACT.createElement("div", {
                        className: "achdeck-progress-fill",
                        style: { width: `${pct}%`, '--achdeck-progress-color': scoreColor }
                    }))
            )
        );
    };
